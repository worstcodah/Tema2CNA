...
namespace WinterService {
  ...
  public sealed partial class StarSignResponse : pb::IMessage<StarSignResponse> {
    ...
    private global::WinterService.StarSign starSign_ = global::WinterService.StarSign.Varsator;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (StarSign != global::WinterService.StarSign.Varsator) hash ^= StarSign.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (StarSign != global::WinterService.StarSign.Varsator) {
    ...
    public void MergeFrom(StarSignResponse other) {
      ...
      if (other.StarSign != global::WinterService.StarSign.Varsator) {
